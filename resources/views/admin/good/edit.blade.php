            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{route('admin.good.create')}}">
                    <span class="hidden-sm-up"><i class="ti-user"></i></span> <span
                        class="hidden-xs-down">biaoji商品</span>
                </a>
            </li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content">
            ...
            <div class="card-body">
                <form action="{{route('admin.good.update',$good)}}" method="post"
                    ...
                    @csrf @method('PUT')
                    <div class="row">
                        <div style="border-right: 1px dashed #cccccc" class="col-9">
                            <!--/row-->
                                ...
                                <div class="col-md-9">
                                    <select name="category_id" class="form-control custom-select"
                                        ...
                                        @foreach($categories as $v)
                                            <option @if($good['category_id'] == $v['id']) selected
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="layui-upload-drag" id="test10">
                                        @if(old('list_pic'))
                                            <img src="{{old('list_pic')}}" alt="" width="50">
                                ...
                                <div class="col-md-9">
                                    <div class="layui-upload">
                                        ...
                                        <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                                            <div class="layui-upload-list" id="demo2" style="overflow: hidden">
                                                @if(old ('pics'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea id="demo" name="content"
                                              style="display: none;">{{$good['content']}}</textarea>
                            ...
                            <div class="card" v-for="(v,k) in specs">
                                ...
                                <div class="card-body">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" v-model="v.spec" value="" placeholder="14寸 64G 内存"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <button class="btn btn-danger btn-sm pull-right" type="button" @click="del(k)">删除
                                    </button>
                                </div>
